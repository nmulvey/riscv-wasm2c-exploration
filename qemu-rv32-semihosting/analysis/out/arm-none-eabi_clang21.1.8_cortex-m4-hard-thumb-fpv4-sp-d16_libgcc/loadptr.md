...
- `CFLAGS` = `-mcpu=cortex-m4 -mfloat-abi=hard -mthumb -mfpu=fpv4-sp-d16 --target=thumbv7em-none-eabihf -O2 -g -ffunction-sections -fdata-sections -Wall -Wextra -Werror -Isrc -DWASM_RT_THREAD_LOCAL= -MMD -MP -I/nix/store/4h9r4ibrq3x14k3jds7m1cvgh88ya6bc-wabt-1.0.41/include -I/nix/store/mzv3p867fyhi31lhj5flazyfbq79jw41-gcc-arm-embedded-15.2.rel1/arm-none-eabi/include`
...
#### Group 2 — 2 configs, 26 instructions
