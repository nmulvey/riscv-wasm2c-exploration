...
int main(int argc, char* argv[]) {
    ...
    if (w2c_function__table_add_one(&instance, 5) != 6)
        success = 0;
    if (w2c_function__table_multiply_two(&instance, 7) != 14)
        success = 0;
    if (w2c_function__table_square(&instance, 4) != 16)
        success = 0;
    if (w2c_function__table_call_by_index(&instance, 0, 5) != 6)
        success = 0;
    if (w2c_function__table_call_by_index(&instance, 1, 5) != 15)
        success = 0;
    if (w2c_function__table_call_by_index(&instance, 2, 7) != 14)
        success = 0;
    if (w2c_function__table_call_by_index(&instance, 3, 7) != 21)
        success = 0;
    if (w2c_function__table_call_by_index(&instance, 4, 4) != 16)
        success = 0;
    if (w2c_function__table_call_by_index(&instance, 10, 5) != 0)
        success = 0;
