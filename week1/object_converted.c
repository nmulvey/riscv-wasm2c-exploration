...
static u32 w2c_foo__object_add(w2c_foo__object*, u32, u32);

FUNC_TYPE_T(w2c_foo__object_t0) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";

static void init_globals(w2c_foo__object* instance) {
}

static void init_memories(w2c_foo__object* instance) {
}

static void init_instance_import(w2c_foo__object* instance, struct w2c_env* w2c_env_instance) {
...
const u64 wasm2c_foo__object_min_env_0x5F_linear_memory = 0;
const u64 wasm2c_foo__object_max_env_0x5F_linear_memory = 65536;
const u8 wasm2c_foo__object_is64_env_0x5F_linear_memory = 0;
const u32 wasm2c_foo__object_pagesize_env_0x5F_linear_memory = 65536;

void wasm2c_foo__object_instantiate(w2c_foo__object* instance, struct w2c_env* w2c_env_instance) {
...
void wasm2c_foo__object_free(w2c_foo__object* instance) {
}
...
u32 w2c_foo__object_add(w2c_foo__object* instance, u32 var_p0, u32 var_p1) {
  ...
  var_i0 = var_l4;
  var_i1 = var_p0;
  i32_store_default32(instance->w2c_env_0x5F_linear_memory, (u64)(var_i0) + 12, var_i1);
  var_i0 = var_l4;
  var_i1 = var_p1;
  i32_store_default32(instance->w2c_env_0x5F_linear_memory, (u64)(var_i0) + 8, var_i1);
  var_i0 = var_l4;
  var_i0 = i32_load_default32(instance->w2c_env_0x5F_linear_memory, (u64)(var_i0) + 12u);
  var_l5 = var_i0;
  var_i0 = var_l4;
  var_i0 = i32_load_default32(instance->w2c_env_0x5F_linear_memory, (u64)(var_i0) + 8u);
  var_l6 = var_i0;
  var_i0 = var_l5;
  var_i1 = var_l6;
  var_i0 += var_i1;
