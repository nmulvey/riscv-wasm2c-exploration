...
static u32 w2c_constant_get_value_0(w2c_constant*);

FUNC_TYPE_T(w2c_constant_t0) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";

/* export: 'get_value' */
u32 w2c_constant_get_value(w2c_constant* instance) {
  u32 ret = w2c_constant_get_value_0(instance);
  return ret;
}

void wasm2c_constant_instantiate(w2c_constant* instance) {
  assert(wasm_rt_is_initialized());
}

void wasm2c_constant_free(w2c_constant* instance) {
}

wasm_rt_func_type_t wasm2c_constant_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  va_list args;
...
u32 w2c_constant_get_value_0(w2c_constant* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = 42u;
  FUNC_EPILOGUE;
